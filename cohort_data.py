def unique_houses(filename):
    ...
    house_list = open(filename)

    for line in house_list:
        line = line.rstrip()
        student_list = line.split("|")
        house_name = student_list[2]
        if house_name:
...
def sort_by_cohort(filename):
    ...
    for line in student_list:
        line = line.rstrip()
        first_name, last_name, house, teacher, cohort = line.split("|")
...
def students_by_house(filename):
    ...
    all_students = [gryffindor, hufflepuff, ravenclaw, slytherin, dumbledores_army, ghosts, instructors]
...
def all_students_tuple_list(filename):
    ...
    for line in students:
        ...
        if house:
            ...
            student_info = tuple([full_name, house, teacher, cohort])
